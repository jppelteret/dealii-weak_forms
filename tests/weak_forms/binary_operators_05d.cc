...
// Check symmetric tensor operator* for symbolic ops
// - Spaces
...
main()
{
  ...
  const SymmetricTensor<2, dim> tensor(unit_symmetric_tensor<dim>());
  // const SymmetricTensor<2,dim,std::complex<double>> complex_tensor
