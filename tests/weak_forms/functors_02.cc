...
run()
{
  ...
  // Test values
  {
    deallog << "Scalar: "
            ...
            << std::endl;
    deallog << "Vector: "
            << v.template operator()<NumberType>(
                 scratch_data, solution_extraction_data)[q_point]
            << std::endl;
    deallog << "Tensor (rank 2): "
            << T2.template operator()<NumberType>(
                 scratch_data, solution_extraction_data)[q_point]
            << std::endl;
    deallog << "Tensor (rank 3): "
            << T3.template operator()<NumberType>(
                 scratch_data, solution_extraction_data)[q_point]
            << std::endl;
    deallog << "Tensor (rank 4): "
            << T4.template operator()<NumberType>(
                 scratch_data, solution_extraction_data)[q_point]
            << std::endl;
    deallog << "SymmetricTensor (rank 2): "
            << S2.template operator()<NumberType>(
                 scratch_data, solution_extraction_data)[q_point]
            << std::endl;
    deallog << "SymmetricTensor (rank 4): "
            << S4.template operator()<NumberType>(
                 scratch_data, solution_extraction_data)[q_point]
            << std::endl;
  }
