...
// - Global component filter (component out of sync with DoF loop)
//
              ...
              for (const unsigned int j : fe_values.dof_indices())
                {
                  ...
                  cell_matrix(i, j) += fe_values.shape_grad(i, q)[component_j] *
              ...
              for (const unsigned int j : fe_values.dof_indices())
                {
                  ...
                  cell_matrix(i, j) +=
                    fe_values[field].gradient(i,
                                              q)[multiplicity_i][component_j] *
                    fe_values[field].gradient(j,
                                              q)[multiplicity_j][component_i] *
                    fe_values.JxW(q);
                }
            }
