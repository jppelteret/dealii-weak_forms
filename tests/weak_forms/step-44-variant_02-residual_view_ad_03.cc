...
// As opposed to replicating step-44 exactly, a follower load is implemented
// to check the assembly of the boundary matrix term.
    ...
    const auto force_u = force_ss_u.template value<ADNumber_t, dim, spacedim>(
      [this,
       &spacedim](const MeshWorker::ScratchData<dim, spacedim> &scratch_data,
        ...
        const Tensor<1, spacedim, ADNumber_t> t = pressure * n_x_da_dA;
        return t;
      },
