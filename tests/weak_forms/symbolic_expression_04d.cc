...
// - Subspace field solution: Symmetric tensor
...
run()
{
  ...
  // Tensor
  {
    ...
    const SubSpaceExtractors::SymmetricTensor<2> subspace_extractor(0,
                                                                    "S",
                                                                    "S");
    ...
    const auto res = -scalar_product(T_val, T_val) + (T_div * T_div);
