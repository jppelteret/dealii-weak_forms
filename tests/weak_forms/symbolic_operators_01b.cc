...
run()
{
                      ...
                      const std::string &                type)
  {
...

    {
      ...
      std::cout
        << "Gradient: "
        << (test[subspace_extractor].gradient().template operator()<NumberType>(
             fe_values_dofs, fe_values_op))[dof_index][q_point]
        << std::endl;
      ...
      std::cout
        << "Curl: "
        << (test[subspace_extractor].curl().template operator()<NumberType>(
             fe_values_dofs, fe_values_op))[dof_index][q_point]
        << std::endl;
      std::cout
        << "Hessian: "
        << (test[subspace_extractor].hessian().template operator()<NumberType>(
             fe_values_dofs, fe_values_op))[dof_index][q_point]
        << std::endl;
...

    {
      ...
      std::cout
        << "Curl: "
        << (trial[subspace_extractor].curl().template operator()<NumberType>(
             fe_values_dofs, fe_values_op))[dof_index][q_point]
        << std::endl;
      std::cout
        << "Hessian: "
        << (trial[subspace_extractor].hessian().template operator()<NumberType>(
             fe_values_dofs, fe_values_op))[dof_index][q_point]
        << std::endl;
      std::cout << "Third derivative: "
