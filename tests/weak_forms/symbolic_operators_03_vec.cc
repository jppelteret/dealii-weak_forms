...
run()
{
       ...
       const std::string &                     type)
  {
...

    {
      ...
      std::cout
        << "Jump in values: "
        << (test.jump_in_values().template operator()<NumberType, width>(
             fe_interface_values, q_point_range))[dof_index]
        << std::endl;
      std::cout
        << "Jump in gradients: "
        << (test.jump_in_gradients().template operator()<NumberType, width>(
             fe_interface_values, q_point_range))[dof_index]
        << std::endl;
      std::cout
        << "Jump in Hessians: "
        << (test.jump_in_hessians().template operator()<NumberType, width>(
             fe_interface_values, q_point_range))[dof_index]
        << std::endl;
      std::cout << "Jump in third derivatives: "
                << (test.jump_in_third_derivatives().template
      ...
      std::cout
        << "Average of values: "
        << (test.average_of_values().template operator()<NumberType, width>(
             fe_interface_values, q_point_range))[dof_index]
        << std::endl;
      std::cout
        << "Jump in gradients: "
        << (test.average_of_gradients().template operator()<NumberType, width>(
             fe_interface_values, q_point_range))[dof_index]
        << std::endl;
      std::cout
        << "Jump in Hessians: "
        << (test.average_of_hessians().template operator()<NumberType, width>(
             fe_interface_values, q_point_range))[dof_index]
        << std::endl;
...

    {
      ...
      std::cout
        << "Jump in values: "
        << (trial.jump_in_values().template operator()<NumberType, width>(
             fe_interface_values, q_point_range))[dof_index]
        << std::endl;
      std::cout
        << "Jump in gradients: "
        << (trial.jump_in_gradients().template operator()<NumberType, width>(
             fe_interface_values, q_point_range))[dof_index]
        << std::endl;
      std::cout
        << "Jump in Hessians: "
        << (trial.jump_in_hessians().template operator()<NumberType, width>(
             fe_interface_values, q_point_range))[dof_index]
        << std::endl;
      std::cout << "Jump in third derivatives: "
                << (trial.jump_in_third_derivatives().template
                    operator()<NumberType, width>(fe_interface_values,
                                                  q_point_range))[dof_index]
                << std::endl;
      ...
      std::cout
        << "Average of values: "
        << (trial.average_of_values().template operator()<NumberType, width>(
             fe_interface_values, q_point_range))[dof_index]
        << std::endl;
      std::cout
        << "Jump in gradients: "
        << (trial.average_of_gradients().template operator()<NumberType, width>(
             fe_interface_values, q_point_range))[dof_index]
        << std::endl;
      std::cout
        << "Jump in Hessians: "
        << (trial.average_of_hessians().template operator()<NumberType, width>(
             fe_interface_values, q_point_range))[dof_index]
        << std::endl;
