...
run()
{
...

  {
    ...
    std::cout << "Trace: "
              << ((trace(f1)).template operator()<NumberType, width>(
                   fe_values, q_point_range))
              << std::endl;
    ...
    // std::cout
    //   << "l1-norm: "
    //   << ((l1_norm(f1)).template operator()<NumberType, width>(fe_values,
    //                                                         q_point_range))
    //   << std::endl;

    // std::cout
    //   << "linfty-norm: "
    //   << ((linfty_norm(f1)).template operator()<NumberType, width>(fe_values,
    //                                                         q_point_range))
    //   << std::endl;
