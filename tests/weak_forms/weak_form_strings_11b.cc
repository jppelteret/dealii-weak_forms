...
run()
{
...

  {
    ...
    assembler += bilinear_form(test_val, s, trial_val).dI() +
                 ...
                 linear_form(test_val, v).dI() +
                 linear_form(test_grad, t2).dI() +
                 linear_form(test_hess, t3).dI();
...

  {
    ...
    assembler +=
      ...
      bilinear_form(test_grad, s, trial_grad).dI() +
      bilinear_form(test_hess, s, trial_hess).dI() +
      bilinear_form(test_d3, s, trial_d3).dI() + linear_form(test_val, v).dI() +
      linear_form(test_grad, t2).dI() + linear_form(test_hess, t3).dI() +
      linear_form(test_d3, t4).dI();
    print_assembler(assembler);
  }
